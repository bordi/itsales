...
function __construct() {
	...
	__('Testimonials', 'wp_hsdtst_widget_loc'), 

	// Widget description
	array( 'description' => __( 'Handsome Testimonials by Ristretto Apps widget to show testimonial in sidebars', 'wp_hsdtst_widget_loc' ), ) 
	);
}
	...
	<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:' ); ?></label> 
	    <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'shortcode_name' ); ?>"><?php _e( 'Design:' ); ?></label>
