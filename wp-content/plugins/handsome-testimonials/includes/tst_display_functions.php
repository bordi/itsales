...
function hndtst_shortcode_single_css( $tst_shortcode, $tstiditr ) {
	...
	*****************************************/
	...
	$tst_css_txt_outer = "
			margin: 2% 3% 3% 2%;
		";
    $tst_image_css_outer_mobile="";
    $tst_css_txt_outer_mobile="";
    ...
    @media (max-width: 568px){
        #tst_image_outer_$tstiditr { $tst_image_css_outer_mobile }
    }
    ";
    ...
    $tst_css .= "
    @media (max-width: 568px){
        #tst_txt_outer_$tstiditr { $tst_css_txt_outer_mobile }
    }
    ";
