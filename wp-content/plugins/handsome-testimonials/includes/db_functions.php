...
register_activation_hook( TSTMT_PLUGIN_DIR . '/handsometestimonials.php','hndtst_saved_disct');
...
/**
 * Saved Pro Discount after installation
 */
function hndtst_saved_disct()
{
	global $current_user;
	$user_id = $current_user->ID;
	$current_date = date('Y-m-d');
	$user_install_date = get_user_meta($user_id, 'hndtst_first_install_date', true);

	if($user_install_date == false)
	{
		add_user_meta($user_id, 'hndtst_first_install_date', $current_date);
	}
}
?>