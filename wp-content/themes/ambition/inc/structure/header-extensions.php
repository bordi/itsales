	...
	<div class="hgroup-wrap">
		...
		$ambition_settings = wp_parse_args(  get_option( 'ambition_theme_settings', array() ),  ambition_get_option_defaults() );
			...
			<?php $args = array(
						...
						'container'      => '',
						'items_wrap'     => '<ul class="nav-menu">%3$s<li class="fancybox"><a href="#contact_form_pop_up" class="fancybox-inline">Регистрация</a></li></ul>',
					); ?>
...
Форма регистрации 
<?php echo do_shortcode('[contact-form-7 id="154" title="Форма регистрации"]'); ?>
</div>
</div></nav><!-- #access -->
